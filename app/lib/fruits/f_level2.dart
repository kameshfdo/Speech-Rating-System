...
import 'dart:io';
import 'dart:convert';
import 'package:app/fruits/f_level3.dart';
...
class FLevel2 extends StatefulWidget {
  const FLevel2({super.key});

  @override
  State<FLevel2> createState() => _FLevel2State();
}

class _FLevel2State extends State<FLevel2> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "orange";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/orange.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,
              ...
              Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => FLevel3()),
                    );
                  },

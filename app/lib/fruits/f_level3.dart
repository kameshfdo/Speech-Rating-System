...
class FLevel3 extends StatefulWidget {
  const FLevel3({super.key});

  @override
  State<FLevel3> createState() => _FLevel3State();
}

class _FLevel3State extends State<FLevel3> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "banana";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/Banana.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,

...
import 'dart:io';
import 'dart:convert';
import 'package:app/fruits/f_level2.dart';
...
class FLevel1 extends StatefulWidget {
  const FLevel1({super.key});

  @override
  State<FLevel1> createState() => _FLevel1State();
}

class _FLevel1State extends State<FLevel1> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "apple";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/apple.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,
              ...
              Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => FLevel2()),
                    );
                  },

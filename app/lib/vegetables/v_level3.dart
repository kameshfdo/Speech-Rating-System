...
class VLevel3 extends StatefulWidget {
  const VLevel3({super.key});

  @override
  State<VLevel3> createState() => _VLevel3State();
}

class _VLevel3State extends State<VLevel3> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "beetroot";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/Beet.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,

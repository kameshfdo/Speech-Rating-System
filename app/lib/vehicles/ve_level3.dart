...
class HLevel3 extends StatefulWidget {
  const HLevel3({super.key});

  @override
  State<HLevel3> createState() => _HLevel3State();
}

class _HLevel3State extends State<HLevel3> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "ship";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/Ship.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,

...
import 'dart:io';
import 'dart:convert';
import 'package:app/vehicles/ve_level3.dart';
...
class HLevel2 extends StatefulWidget {
  const HLevel2({super.key});

  @override
  State<HLevel2> createState() => _HLevel2State();
}

class _HLevel2State extends State<HLevel2> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "airplane";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/Airplane.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,
              ...
              Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => HLevel3()),
                    );
                  },

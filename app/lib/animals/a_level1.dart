...
import 'dart:io';
import 'dart:convert';
import 'package:app/animals/a_level2.dart';
...
class ALevel1 extends StatefulWidget {
  const ALevel1({super.key});

  @override
  State<ALevel1> createState() => _ALevel1State();
}

class _ALevel1State extends State<ALevel1> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "dog";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/dog.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,
              ...
              Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ALevel2()),
                    );
                  },

...
class ALevel3 extends StatefulWidget {
  const ALevel3({super.key});

  @override
  State<ALevel3> createState() => _ALevel3State();
}

class _ALevel3State extends State<ALevel3> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "cow";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/cow.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,

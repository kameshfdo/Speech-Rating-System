...
import 'dart:io';
import 'dart:convert';
import 'package:app/animals/a_level3.dart';
...
class ALevel2 extends StatefulWidget {
  const ALevel2({super.key});

  @override
  State<ALevel2> createState() => _ALevel2State();
}

class _ALevel2State extends State<ALevel2> {
  String _status = "Identify the Image";
  String _responseText = "";
  bool _isRecording = false;
  FlutterSoundRecorder? _recorder;
  String? _filePath;
  final String _targetValue = "lion";
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset('assets/pictures/lion.png'),
                    ),
                    SizedBox(height: 10),
                    Text(
                      _status,
              ...
              Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ALevel3()),
                    );
                  },
